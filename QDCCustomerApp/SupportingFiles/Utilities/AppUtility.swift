...
func showAlertMessage(vc: UIViewController, title:AlertTitleType, message:String) -> Void {
    let alertCtrl = UIAlertController(title: title.rawValue, message: message, preferredStyle: UIAlertControllerStyle.alert)
...
let mainColor: UIColor = PERFECTAPP// #colorLiteral(red: 0.541176470588235, green: 0.756862745098039, blue: 0.227450980392157, alpha: 1)//#colorLiteral(red: 0.9843137255, green: 0.4666666667, blue: 0.02352941176, alpha: 1)//
let buttonBGColor: UIColor = PERFECTAPP//#colorLiteral(red: 0.541176470588235, green: 0.756862745098039, blue: 0.227450980392157, alpha: 1)//#colorLiteral(red: 0.9843137255, green: 0.4666666667, blue: 0.02352941176, alpha: 1)
let menuBGColor: UIColor = #colorLiteral(red: 0.1411764706, green: 0, blue: 0.6392156863, alpha: 1)
let mainNavBarColor:UIColor = PERFECTAPP//#colorLiteral(red: 0.541176470588235, green: 0.756862745098039, blue: 0.227450980392157, alpha: 1)//#colorLiteral(red: 0.9843137255, green: 0.4666666667, blue: 0.02352941176, alpha: 1)
